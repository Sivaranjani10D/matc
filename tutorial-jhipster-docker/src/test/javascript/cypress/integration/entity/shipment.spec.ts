...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { shippedAt: '2022-06-07' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {"name":"Open-architected","totalAmount":44483,"ordered":"2022-06-08"},
    }).then(({ body }) => {
      shoppingOrder = body;
    });
    // create an instance at the required relationship entity:
  ...
  describe('new Shipment page', () => {
    ...
    it.skip('should create an instance of Shipment', () => {
      cy.get(`[data-cy="shippedAt"]`).type('2022-06-07').should('have.value', '2022-06-07');
